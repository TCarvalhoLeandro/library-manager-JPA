...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Livro l1 = new Livro(null, "Dom Casmurro", 1, "978-8532515087", 1899, true, a);
		Livro l2 = new Livro(null, "Memórias Póstumas de Brás Cubas", 1, "978-8532531391", 1881, true, a);
		Livro l3 = new Livro(null, "A Hora da Estrela", 1, "978-8532530660" , 1977, true, b);
		Livro l4 = new Livro(null, "Perto do Coração Selvagem", 1, "978-8532517524" , 1943, true, b);
